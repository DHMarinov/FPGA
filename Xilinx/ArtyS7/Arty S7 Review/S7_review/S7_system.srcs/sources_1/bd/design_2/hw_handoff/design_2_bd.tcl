...
proc create_root_design { parentCell } {
  ...
  # Create instance: Arty_RGB_AXI_0, and set properties
  set Arty_RGB_AXI_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Arty_RGB_AXI:1.0 Arty_RGB_AXI_0 ]
 ...
 ] [get_bd_intf_pins /Arty_RGB_AXI_0/s00_axi]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M01_AXI [get_bd_intf_pins Arty_RGB_AXI_0/s00_axi] [get_bd_intf_pins microblaze_0_axi_periph/M01_AXI]
  ...
  # Create port connections
  connect_bd_net -net Arty_RGB_AXI_0_rgb_led [get_bd_ports rgb_led] [get_bd_pins Arty_RGB_AXI_0/rgb_led]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins Arty_RGB_AXI_0/s00_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_led/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins mig_7series_0/clk_ref_i] [get_bd_pins mig_7series_0/sys_clk_i] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins Arty_RGB_AXI_0/s00_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_led/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs Arty_RGB_AXI_0/s00_axi/reg0] SEG_Arty_RGB_AXI_0_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x40000000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_gpio_1/S_AXI/Reg] SEG_axi_gpio_1_Reg
