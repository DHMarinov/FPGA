...
HD_PWD='D:/Workspaces/Xilinx/ip_test/Dual_DAC/Dual_DAC.runs/design_1_AD5065_Dual_DAC_RTL_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_AD5065_Dual_DAC_RTL_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_AD5065_Dual_DAC_RTL_0_1.tcl
