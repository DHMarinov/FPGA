...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, resetn, r0_val, g0_val, b0_val, r1_val, g1_val, 
  b1_val, led0_r, led0_g, led0_b, led1_r, led1_g, led1_b)
/* synthesis syn_black_box black_box_pad_pin="clk,resetn,r0_val[7:0],g0_val[7:0],b0_val[7:0],r1_val[7:0],g1_val[7:0],b1_val[7:0],led0_r,led0_g,led0_b,led1_r,led1_g,led1_b" */;
  input clk;
  input resetn;
  input [7:0]r0_val;
  input [7:0]g0_val;
