...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_RGB_controller is
  ...
  signal \pwm_counter[7]_i_6_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \freq_counter[4]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \freq_counter[5]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \freq_counter[5]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \freq_counter[8]_i_4\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \pwm_counter[2]_i_1\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \pwm_counter[7]_i_5\ : label is "soft_lutpair3";
begin
...
\pwm_counter[7]_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
